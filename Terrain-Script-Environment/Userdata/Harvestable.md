...
- <code>initialPosition</code> [<strong> vec3 </strong>] <br></br>

	- <code>Get</code>: The harvestable's initial world position.


- <code>initialRotation</code> [<strong> quat </strong>] <br></br>
...
- [<strong> vec3 </strong>]: The max bounds.
- [<strong> vec3 </strong>]: The min bounds.
...
Returns the [Character](/lua/Game-Script-Environment/Userdata/Character) that is seated in the kinematic.

<strong>Arguments:</strong> <br></br>

- <code>kinematic</code> [<strong> harvestable </strong>]: The kinematic.
...
Requests to seat a [Character](/lua/Game-Script-Environment/Userdata/Character) in the kinematic.
